...
const SITE_KEY = "6Le68JYrAAAAAJgzVaqhBUinxaxQVIfgIcOE-B9z"
...
export default function Portfolio() {
  ...
  const handleFormSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const templateParams = {
        ...
        to_name: "Ishika Agrawal",
        to_email: "agrawalishika160@gmail.com",
      }
  ...
  const handleDownloadCV = () => {
    const driveLink =" https://drive.google.com/uc?export=download&id=1W2_h6MsyU7EEPeXZVmLKoUP4bUk21y0t"
        ...
        <div className={`min-h-screen transition-all duration-300 ease-in-out ${darkMode ? "dark" : ""}`}>
          ...
          >
            <div className="text-center max-w-4xl mx-auto">
              <motion.h1
                className="text-6xl md:text-8xl lg:text-9xl font-bold bg-gradient-to-r from-blue-600 via-indigo-600 to-slate-700 dark:from-gray-100 dark:via-gray-200 dark:to-gray-300 bg-clip-text text-transparent mb-6 left_side"
                initial={{ opacity: 0, y: 30 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5, ease: "easeOut" }}
              >
                <TypingAnimation text="Ishika Agrawal" delay={80} />
              </motion.h1>
              ...
              >
                Empowering Strategic Decisions Through Advanced Analytics
              </motion.p>
              ...
              >
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                  ...
                  >
                    <a
                      href="https://www.linkedin.com/in/ishika-agrawal-540a06312/"
                      target="_blank"
                ...
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                  ...
                  >
                    <a href="https://github.com/IshikaAgrawal27" target="_blank" rel="noopener noreferrer">
            ...
            <div className="max-w-6xl mx-auto">
              ...
              >
                <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
                  I'm a Computer Science undergraduate with a deep curiosity for how technology shapes the world — and
                  how we can reimagine it through data-driven decisions. What began as a passion for programming and web
                  development naturally evolved into an interest in systems, networks, and data — especially the
                  patterns and stories hidden within.
                </p>
                <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
                  With a strong foundation in front-end technologies like HTML, CSS, and JavaScript, I've transitioned
                  my focus toward becoming a Java Data Analyst. I'm actively building backend skills using Node.js and
                  Spring Boot, while learning how to design scalable, performant, and secure data systems. My goal isn't
                  just to write code, but to solve real-world problems with insight, structure, and clarity.
                </p>
                <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
                  My CCNA training gave me a hands-on understanding of networking fundamentals like IP addressing,
                  subnetting, and routing — deepening my appreciation for how data flows across systems. This technical
                  grounding has sparked a broader interest in cybersecurity, ethical hacking, cloud computing, and
                  DevOps — critical intersections for modern data-driven development.
                </p>
                <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
                  At heart, I approach tech with both a builder's mindset and an analyst's curiosity. Whether I'm
                  dissecting datasets, optimizing queries, or exploring Linux internals, I'm constantly driven to
                  understand the "why" behind the system — and how data can be used to improve it.
                </p>
                <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
                  Above all, I'm committed to continuous learning, meaningful problem-solving, and staying agile in a
              ...
              <div className="grid md:grid-cols-3 gap-6">
                ...
                >
                  <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-700/20 dark:to-gray-600/20 rounded-2xl p-6 border border-blue-100 dark:border-gray-600/30 h-fit">
                    ...
                    <p className="text-gray-700 dark:text-gray-300">
                      Strengthening backend and data analytics skills using Java, SQL, and Python.
                    </p>
                  </div>
                </motion.div>
                <motion.div
                ...
                >
                  <div className="bg-gradient-to-r from-indigo-50 to-slate-50 dark:from-gray-600/20 dark:to-gray-700/20 rounded-2xl p-6 border border-indigo-100 dark:border-gray-600/30 h-fit">
                    ...
                    <p className="text-gray-700 dark:text-gray-300">
                      Data analysis, backend systems, cybersecurity, and cloud computing.
                    </p>
                  </div>
                </motion.div>
                <motion.div
                ...
                >
                  <div className="bg-gradient-to-r from-slate-50 to-blue-50 dark:from-gray-700/20 dark:to-gray-600/20 rounded-2xl p-6 border border-slate-100 dark:border-gray-600/30 h-fit">
                    ...
                    <p className="text-gray-700 dark:text-gray-300">
                      Become a Data Analyst and grow into Data Engineering or Security Analytics.
                    </p>
                  </div>
                </motion.div>
              </div>
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="space-y-8">
                {[
                  ...
                  {
                    institution: "Maa Sharda Vidhyapeeth Higher Secondary School, Harda",
                    degree: "12th - MPBSE",
                    period: "2021 - 2022",
                    ...
                    <CardHeader>
                      <div className="flex items-start justify-between">
                        ...
                        <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                          ...
                          >
                            <a
                              href="https://drive.google.com/file/d/1tj2iFGZJZU-cp1G7w5dAZayTHNYi_7Ok/view?usp=sharing"
                              target="_blank"
                              rel="noopener noreferrer"
                            >
                    ...
                    <CardHeader>
                      <div className="flex items-start justify-between">
                        ...
                        <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                          ...
                          >
                            <a
                              href="https://drive.google.com/file/d/1vUdVXc7BbzUnBi1HBFmv_XXAHjEsST17/view?usp=sharing"
                              target="_blank"
                              rel="noopener noreferrer"
                            >
                              <ExternalLink className="w-4 h-4 mr-2" />
                ...
                >
                  <Card className="bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-gray-700/10 dark:to-gray-600/10 border border-blue-100 dark:border-gray-600/30 hover:shadow-lg transition-all duration-200 h-full">
                    <CardHeader>
                      <div className="flex items-start justify-between">
                        ...
                        <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                          ...
                          >
                            <a
                              href="https://drive.google.com/file/d/1giSuAbXssn4vh99OMJDaHjta8TeR37qR/view?usp=sharing"
                              target="_blank"
                              rel="noopener noreferrer"
                            >
                              <ExternalLink className="w-4 h-4 mr-2" />
                    ...
                    <CardContent>
                      ...
                      <p className="text-gray-600 dark:text-gray-300">
                        Comprehensive data analytics simulation covering business intelligence, data visualization, and
          ...
          <footer className="py-12 px-6 bg-gradient-to-br from-indigo-50 via-blue-50 to-slate-50 dark:from-gray-800 dark:via-gray-900 dark:to-gray-800 border-t border-blue-100 dark:border-gray-600/30 transition-all duration-300">
            <div className="max-w-6xl mx-auto text-center">
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <p className="text-gray-600 dark:text-gray-300 mb-6">© 2025 Ishika Agrawal. All rights reserved.</p>
